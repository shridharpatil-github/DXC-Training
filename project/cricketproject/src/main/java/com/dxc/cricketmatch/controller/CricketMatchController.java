 ...
 */
@Api(value = "Cricket Match", description = "User can recommend match and also user can view recommended matches")
@RestController
...
public class CricketMatchController {
	...
	@ApiParam(name = "newMatch", type = "NewMatch",value = "New Match information",required = true)
	 ...
	 */
	@ApiOperation(value = "view all Recommended matches", response = CricketMatchResponse.class)
	 ...
	 */
	@ApiOperation(value = "unrecommending the match", response = CricketMatchResponse.class)
	@ApiParam(name = "matchId", type = "String", value = "match id for unrecommend match", required = true)
