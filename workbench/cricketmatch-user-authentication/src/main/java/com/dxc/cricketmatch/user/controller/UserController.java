...
public class UserController {
	 ...
	 * @return response
	 */
	@ApiOperation(value = "Creating user account", response = UserResponse.class)
	 ...
	 */
	@ApiOperation(value = "Login credential", response = UserResponse.class)
	@ApiParam(name = "email, password", value = "email-id and password", required =true)
	 ...
	 * @return UserResponse
	 */
	@ApiOperation(value = "User details", response = UserResponse.class)
	@ApiParam(name = "email", type = "String", value = "user id")
	 ...
	 * @return UserResponse
	 */
	@ApiOperation(value = "update profile", response = UserResponse.class)
	@ApiParam(name = "user", value = "user details")
