package com.dxc.cricketmatch.user.aspectj;
...
public class LoggingAspect {
	 ...
	 * 
	 */
	@Pointcut(value = "execution(* com.dxc.cricketmatch.user.controller.*.*(..))")
	 ...
	 * @param exception
	 */
	@AfterThrowing(pointcut = "execution(* com.dxc.cricketmatch.user.controller.*.*(..))", throwing = "exception")
	 ...
	 * @param val
	 */
	@AfterReturning(pointcut = "execution(* com.dxc.cricketmatch.user.controller.*.*(..))", returning = "val")
